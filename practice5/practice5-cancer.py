...
fnres = 'consoleResultsCancer.txt'
fres = open(fnres, 'w')
...
# Create the graphviz dot file for the cancer dataset
export_graphviz(tree_clf, out_file=os.path.join(IMAGES_PATH, "cancer_tree.dot"),
                feature_names=cancer.feature_names, class_names=cancer.target_names, rounded=True, filled=True)
Source.from_file(os.path.join(IMAGES_PATH, "cancer_tree.dot"))

# Create the tree png
treepng = "cancer_tree.png"
cmd = ["dot", "-Tpng", os.path.join(IMAGES_PATH, "cancer_tree.dot"),
