...
plot_decision_boundary(tree_clf, X, y, axes=[0,10,0,10])
plt.plot([5.45, 5.45], [0, 10], "k-", linewidth=2)
plt.plot([5.45, 10], [2.8, 2.8], "k--", linewidth=2)
#plt.text(4, 1.0, "Depth=0", fontsize=15)
#plt.text(6, 3, "Depth=1", fontsize=13)
...
plt.plot([12.79, 12.79], [0, 10], "k-", linewidth=2)
plt.plot([12.79, 15], [2.275, 2.275], "k--", linewidth=2)
#plt.text(11, 1.0, "Depth=0", fontsize=15)
#plt.text(13, 3, "Depth=1", fontsize=13)
...
plt.plot([13.095, 13.095], [0, 30], "k-", linewidth=2)
plt.plot([13.095, 30], [19.165, 19.165], "k--", linewidth=2)
#plt.text(11, 1.0, "Depth=0", fontsize=15)
#plt.text(13.1, 20, "Depth=1", fontsize=13)
